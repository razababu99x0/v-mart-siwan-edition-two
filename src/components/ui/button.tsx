...
const buttonVariants = cva("button", { variants: { variant: { default: "button-primary", outline: "button-outline", dark: "button-dark", ghost: "button-ghost" }, size: { default: "", sm: "button-sm", icon: "icon-button" } }, defaultVariants: { variant: "default", size: "default" } });
